...
/** @import { GlobalId, Priority, Status, TaskType, TRACKER_DIR_TYPES, LEGACY_TRACKER_DIR_TYPES } from './schema.js' */
 ...
 * @returns {{ name: TRACKER_DIR_TYPES, path: string } | undefined}  undefined if neither form is there
 ...
 *
 * @param {string} dir
 * @returns {{ name: LEGACY_TRACKER_DIR_TYPES, path: string } | undefined}
 */
