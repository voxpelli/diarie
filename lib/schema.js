...
/** @typedef {VALID_ERROR_CODES[number]} ErrorCode */
 ...
 */
export function defaultTrackerDir (dotted) {
  return dotted ? TRACKER_DIRS[1] : TRACKER_DIRS[0];
}
 ...
 *
 * @param {unknown} v
 * @returns {v is TRACKER_DIRS[number] | LEGACY_TRACKER_DIRS[number]}
 */
export const isAnyStoreDir = (v) => isTrackerDir(v) || guardedArrayIncludes(LEGACY_TRACKER_DIRS, v);
