 ...
 * makes the typo TS2820 instead — measured by planting `'descripton'` and reading what `tsc`
 * actually says, which is better than TS2322: 2820 is the "did you mean" arm, so the compiler
 * names the correction rather than only the mismatch.
 */
