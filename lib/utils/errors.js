 ...
 * `store.js`, the flags, the commands — and doing so is a downward dependency, not a
...
export class InputError extends Error {
   ...
   * @param {string} [body]
   * @param {import('../schema.js').ErrorCode} [code]  machine-readable tag for --json consumers.
  ...
  constructor (message, body, code, options) {
    ...
    /** @type {import('../schema.js').ErrorCode|undefined} */
    this.code = code;
  }
}
