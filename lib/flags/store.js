...
import { resolveRoot } from '../store.js';
 ...
 *
 * The store errors now extend `InputError` at their definition (see `lib/store.js`), so they
 ...
 * @returns {string}
 * @throws {import('../utils/errors.js').InputError}
 */
