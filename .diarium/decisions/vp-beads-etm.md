...
- Every working agent-native tracker is single-kind or typeless: ralph prd.json (userStory only), Anthropic feature\_list.json, git-bug (labels only).
